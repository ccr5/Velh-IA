    ...
    <div className="App">
      ...
      <div className="container-fluid" style={{ minHeight: window.innerHeight - 110 }}>
        <div className="jumbotron field">
          ...
          <p className="lead">
            The MAS is the key of whole research. He was programmed applying Social Fact and
            functionalism theory to simulate our human relations. The video below presents the whole
